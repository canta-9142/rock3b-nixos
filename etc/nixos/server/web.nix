...
in
{
  ...
  systemd.tmpfiles.rules = [
    "d ${homelab.siteRoot} 2775 site-deploy site-deploy -"
    "d ${homelab.siteRoot}/releases 2775 site-deploy site-deploy -"
    "d ${homelab.siteRoot}/.staging 2770 site-deploy site-deploy -"
